...
<template>
    <div
        class="flex h-[100dvh] flex-col bg-gray-100 bg-[url('/images/bg.jpg')] bg-cover bg-center"
        style="min-height: -webkit-fill-available"
    >
        <header
            class="w-full px-8 py-4 border-b border-b-black border-opacity-20 bg-black/20"
        >
            <div
                :class="{
        ...
        <footer
            class="w-full px-8 py-4 text-white border-t border-t-black border-opacity-20 bg-black/20"
        >
            <div
        ...
        <ConfirmationModal :show="showConfirmationModal">
            ...
            <template #footer>
                ...
                <button
                    type="button"
                    @click="clearChat"
                    class="ml-3 inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm bg-slate-600 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
                >
                    Clear
                </button>
            </template>
